...
let chars = "ABCÇDEFGĞHIİJKLMNOÖPRSŞTUÜVYZabcçdefgğhıijklmnoöprsştuüvyz0123456789";
let randText = "";
...
let hexademical = "0123456789abcdef";
let randHex = "";
for ( let i = 0; i<6; i++){
    randHex += hexademical.charAt(Math.floor(Math.random() * hexademical.length))
}
console.log(`#${randHex}`)
